...
1. Open the live website:
   👉 [https://admirable-biscuit-ecdcfb.netlify.app/](https://admirable-biscuit-ecdcfb.netlify.app/)
...
- Your selected theme is saved in the browser, so it will remain the same even after refreshing the page.
...
When a course filter is selected, only CT cards from that course will be shown. Switching between filters will not remove your edits.
...
- Your saved data is tied to the browser and this website address:
  **https://admirable-biscuit-ecdcfb.netlify.app/**
...
To make a schedule change visible to **everyone**, the default schedule in the website source code must be updated and the updated version must be deployed to **Netlify** again.
...
[🚀 Open CT Exam Dashboard](https://admirable-biscuit-ecdcfb.netlify.app/)
